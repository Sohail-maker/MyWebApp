       ...
       public  string ticket = null;
        ...
        void printlabel()
        {
           ...
           command   = (
                    ...
                    + "CLS"                                                                                    + "\n"
                    + $"{btmp}"                                                                                + "\n"
                    + $"BARCODE 130,14,\"128M\",53,0,90,4,12,\"!105{lblitmNumber.Text}\""                      + "\n"
                    ...
                    + $"TEXT 74,138,\"7\",90,1,1,\"{lblitmNumber.Text}\""                                      + "\n"
                    + "BAR 80,600,300,10"                                                                      + "\n"
                    + "PRINT 1,1"                                                                              + "\n" );
